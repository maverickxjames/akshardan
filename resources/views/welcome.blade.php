                    ...
                    <div class="col align-self-start">
                        <div class="ul-banner-img">
                            <div class="img-wrapper">
                                <img src="assets/img/cutegirl2.png" alt="Banner Image">
                ...
                <div class="row row-cols-md-2 row-cols-1 align-items-center gy-4 ul-about-row">
                    ...
                    <div class="col">
                        <div class="ul-about-txt">
                            ...
                            <p class="ul-section-descr">अक्षरदान फाउंडेशन में आपका स्वागत है, जो हमारे समुदाय में ज़रूरतमंदों के लिए प्रकाश और समर्थन का एक प्रतीक है। हम करुणा की शक्ति और हर व्यक्ति की गरिमा में विश्वास करते हैं। अक्षरदान फाउंडेशन में, हम ज़रूरतमंदों की सेवा प्रेम और सम्मान के साथ करने के लिए समर्पित हैं। बुनियादी ज़रूरतें प्रदान करने से लेकर आत्मनिर्भरता के अवसर पैदा करने तक, हमारा मिशन एक ऐसे समाज का निर्माण करना है जहाँ हर किसी को सम्मान और उद्देश्य के साथ जीवन जीने का अवसर मिले। आइए, एक समय में एक जीवन को बेहतर बनाकर इस बदलाव का हिस्सा बनें।</p>
                ...
                <div class="ul-donate-form-section">
                    <div class="row justify-content-between align-items-center">
                        ...
                        <div class="col-lg-6 position-relative">
                            ...
                            <img src="assets/img/donate-form-vector.svg" alt="vector" class="ul-donate-form-vector">
                        </div>
